...
<div class="container">
    ...
    <form method="POST" action="/schedule/">
      ...
      <div class="form-group">
        ...
        <input type="datetime-local" class="form-control" id="dateInput" name="date_start" value="{{$schedule->election_start_date ?? ''}}">
      </div>

      <div class="form-group">
        <label for="dateInput">Tanggal berakhir pemilihan</label>
        <input type="datetime-local" class="form-control" id="dateInput" name="date_end" value="{{$schedule->election_end_date ?? ''}}">
      </div>
